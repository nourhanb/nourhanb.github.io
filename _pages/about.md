...
Hello! I'm Nour, and I hold a PhD in AI for medical imaging from the University of British Columbia, where I conducted my research within the Biomedical Signal and Image Computing Laboratory [(BiSICL)](https://bisicl.ece.ubc.ca/). My work, supported by the prestigious NSERC PhD Vanier fellowship, focused on advancing lifelong learning and domain generalization in deep networks for medical applications. I had the privilege of being mentored by Professor [Rafeef Garbi](https://scholar.google.com/citations?hl=en&user=Mwscz1IAAAAJ&view_op=list_works&sortby=pubdate) and collaborating with Professor [Ghassan Hamarneh](https://scholar.google.com/citations?hl=en&user=61DdlkAAAAAJ&view_op=list_works&sortby=pubdate) from the Medical Image Analysis Laboratory [(MIA)](https://www.medicalimageanalysis.com/) at Simon Fraser University.  
